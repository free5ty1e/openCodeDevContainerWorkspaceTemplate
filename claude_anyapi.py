#!/usr/bin/env python3
"""
AnyAPI → Claude Code Bridge Script

Bridges AnyAPI models with the Claude Code CLI via a local litellm proxy.
"""
import argparse
import os
import sys
...
def main():
    ...
    api_key = get_and_cache_api_key(CACHE_FILE, "ANYAPI_API_KEY", clear=args.clear_api_key)
    if api_key is None:
