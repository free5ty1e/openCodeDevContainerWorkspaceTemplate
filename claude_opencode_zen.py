#!/usr/bin/env python3
"""
OpenCode Zen → Claude Code Bridge Script

Bridges OpenCode Zen models with the Claude Code CLI via a local litellm proxy.
"""
import argparse
import os
import sys
...
def fetch_models(api_key):
    ...
    try:
        ...
        return [{"id": m["id"], "owned_by": "community", "context_window": m["context_window"]}
                for m in OPENCODE_KNOWN_FREE_MODELS]


# Curated list of KNOWN FREE MODELS from OpenCode Zen
OPENCODE_KNOWN_FREE_MODELS = [
    {"id": "big-pickle", "context_window": 200000},
    {"id": "hy3-free", "context_window": 200000},
    {"id": "laguna-s-2.1-free", "context_window": 1048576},
    {"id": "ling-3.0-flash-fin-free", "context_window": 200000},
    {"id": "deepseek-v4-flash-free", "context_window": 200000},
    {"id": "nemotron-3-ultra-free", "context_window": 1048576},
    ...
    {"id": "nemotron-3.5-lightning-free", "context_window": 200000},
]
...
def generate_litellm_config(selected_model, api_key, context_window=None):
    ...
    if context_window is None or context_window <= 0:
        CONTEXT_WINDOWS = {
            ...
            "nemotron-3.5-lightning-free": 1048576,
        }
...
def main():
    ...
    api_key = get_and_cache_api_key(CACHE_FILE, "OPENCODE_ZEN_API_KEY", clear=args.clear_api_key)
    if api_key is None:
