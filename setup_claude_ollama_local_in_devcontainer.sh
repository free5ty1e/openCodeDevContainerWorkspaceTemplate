...
echo "mkdir -p .claude_persist && CLAUDE_CONFIG_DIR=".claude_persist" CLAUDE_CODE_AUTO_COMPACT_WINDOW=175000 CLAUDE_CODE_MAX_OUTPUT_TOKENS=16384 CLAUDE_AUTOCOMPACT_PCT_OVERRIDE=91 OLLAMA_HOST=http://host.docker.internal:11434 ollama launch claude --model nemotron-3.5-lightning:30b-mlx -- --dangerously-skip-permissions"
echo ""
echo ""
